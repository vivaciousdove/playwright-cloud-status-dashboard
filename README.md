...
Primary proof artifacts are generated by the automation pipeline:
...
Tip:  
Download the **playwright-report** artifact from the GitHub Actions run and open `index.html` locally.
